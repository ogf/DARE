...
\begin{itemize}
  ...
  \item DARE-workers: Es clave para lograr la escabilidad del
    ...
    correspondiente. Para lograr el objetivo de escabilidad y un nivel
    de fiabilidad mayor se pueden lanzar numerosos workers.
  ...
  \item DARE-backend: Es el encargado de comunicarse con la base de
    datos MongoDB tanto para leer como escribir los objetos definidos
    en DARE-domain. Recibe también peticiones de ejecución para
    aAUTOMATOR. Para llevarlas a acabo utiliza la parte cliente de
    DARE-workers.
  ...
  \item DARE-web: Este módulo se utiliza para facilitar el despliegue
    ...
    ligero, por lo que es especialmente indicado para lanzar numerosas
  ...
  \item DARE-python: Este módulo implemente la librería cliente para
    ...
    funcionalidad. Lógicamente está implementado en Python.
...
La documentación del proyecto se presenta en único volumen que
