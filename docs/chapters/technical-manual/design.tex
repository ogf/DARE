...
Como mencionabamos antes, este componente está implementado en
...
Clojure. Hemos decidido, también, que la mejor de describir la
implementación de DARE-backend es utilizar técnicas de programación
literaria.
