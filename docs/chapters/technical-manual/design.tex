...
clases hemos creido conveniente utilizar algunas técnicas adicionales
...
que el código esta en este mismo idioma.
...
contiene metodos para crear nuevas entidades y para acceder a las
...
La clase Server contiene varios metodos para realizar acciones en el
...
responsibilidades indicadas en el diagrama.
...
utilizaun esquema fijo de manera explícita si que se podría decir que
...
indicado. Para cada colección\footnote{Equivalente a table en una base
...
milisegundos que llevo realizar la ejecución incluído tiempo de espera
